...
with open('Project-covid-19/Covid-19/config.json','r') as c:
...
app.config['SQLALCHEMY_DATABASE_URI']='mysql://root:@localhost/project-covid-19'
db=SQLAlchemy(app)
...
def patient():
    ...
    if request.method=="POST":
        ...
        subject="COVID-19:Always Caring About Your Health"
